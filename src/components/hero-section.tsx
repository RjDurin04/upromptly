...
import { Sparkles, Code2, PenLine, Lightbulb } from "lucide-react";
...
const SUGGESTIONS = [
    {
        ...
        icon: Code2,
        prompt: "Write a strict, senior-level code review for a bloated React component. Focus on memoization, extracting pure functions, and early returns.",
        color: "text-blue-400",
        bg: "bg-blue-400/10",
    },
    {
        ...
        icon: PenLine,
        prompt: "Write a high-converting, emotionally resonant launch email for a new B2B productivity tool. Tone: authoritative yet accessible. Do not use corporate jargon.",
    ...
    },
    {
        ...
        icon: Lightbulb,
        prompt: "Act as a fractional CMO. Brainstorm 5 unconventional go-to-market strategies for a developer-focused cybersecurity startup targeting mid-market CTOs.",
...
export function HeroSection() {
    ...
    const textareaRef = document.getElementById("prompt-input") as HTMLTextAreaElement | null;

    const handleSuggestionClick = useCallback((promptText: string) => {
        ...
        <div className="w-full pb-8">
            <div className="mb-8 max-w-2xl">
                ...
                <p className="text-[15px] leading-relaxed text-foreground/50 text-balance">
                    Stop fighting with language models. Describe what you want in plain words, and Upromptly will compile it into an attention-optimized, highly constrained system prompt ready for execution.
                </p>
            </div>
