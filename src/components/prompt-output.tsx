...
import { Copy, Plus, Check, Sparkles, RefreshCw } from "lucide-react";
...
export function PromptOutput() {
    ...
    const clearCurrentSession = usePromptStore((state) => state.clearCurrentSession);
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <span className={cn("absolute inset-0 flex items-center justify-center transition-all duration-300", hasCopied ? "scale-100 opacity-100" : "scale-50 opacity-0")}>
                            <Check className="h-4 w-4" />
                        </span>
                        <span className={cn("absolute inset-0 flex items-center justify-center transition-all duration-300", hasCopied ? "scale-50 opacity-0" : "scale-100 opacity-100")}>
